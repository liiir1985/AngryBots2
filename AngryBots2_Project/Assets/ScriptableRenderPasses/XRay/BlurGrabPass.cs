...
{
    const string k_RenderGrabPassTag = "Custom Blur Pass";
    ...
    public override void Execute(ScriptableRenderer renderer, ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        using (new ProfilingSample(buf, k_RenderGrabPassTag))
        {
            ...
            //Blit Blur To Screen After Opaque Pass
            //buf.SetGlobalTexture("_BlitTex", blurredID);
            //buf.Blit(blurredID, m_ColorHandle.Identifier());
